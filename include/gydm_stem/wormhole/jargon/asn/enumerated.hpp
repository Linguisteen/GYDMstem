...
inline E asn_octets_to_##e(const WarGrey::STEM::octets& benum, size_t* offset = nullptr) { return asn_octets_to_enum<E>(benum.c_str(), offset); }
    ...
    template<typename E>
    inline WarGrey::STEM::octets asn_enum_to_octets(E enumerated) {
