...
inline GYDM::octets asn_##e##_to_octets(E e) { return asn_enum_to_octets(e); } \
...
inline E asn_octets_to_##e(const GYDM::octets& benum, size_t* offset = nullptr) { return asn_octets_to_enum<E>(benum.c_str(), offset); }
    ...
    template<typename E>
    inline GYDM::octets asn_enum_to_octets(E enumerated) {
